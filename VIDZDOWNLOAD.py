...
<section class="controls"><button id="folderBtn">FOLDER</button><button id="startBtn">START</button><button id="stopBtn">STOP</button><button id="sendBtn">READY</button></section>
